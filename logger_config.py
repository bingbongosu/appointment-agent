...
# level is the logging level (default is INFO)
def setup_logger(
    name="app_logger",
    log_file=None,
    ...
    #set the logging level to the specified level (default is INFO)
    ...
    # If output_mode is "silent", add a NullHandler to suppress all logging output
    if output_mode == "silent":
        logger.addHandler(logging.NullHandler())
        return logger

    # If output_mode is "console" or "both", add a StreamHandler to output logs to the console
    ...
    # If output_mode is "file" or "both", add a FileHandler to write logs to the specified file
